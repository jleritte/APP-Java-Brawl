public class BrawlDeck
{
	...
	public BrawlDeck(String character,short x)
	{
		...
		{	buildDeck(bennett,x);System.out.println("Bennett");}
		else if(character.equals("Chris"))
		{	buildDeck(chris,x);System.out.println("Chris");}
		else if(character.equals("Darwin"))
		{	buildDeck(darwin,x);System.out.println("Darwin");}
		else if(character.equals("Hale"))
		{  buildDeck(hale,x);System.out.println("Hale");}
		else if(character.equals("Morgan"))
		{	buildDeck(morgan,x);System.out.println("Morgan");}
		else if(character.equals("Pearl"))
		{	buildDeck(pearl,x);System.out.println("Pearl");}
	}
